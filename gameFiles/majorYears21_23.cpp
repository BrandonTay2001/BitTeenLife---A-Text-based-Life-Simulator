...
void Events21 ( Stats &s, int happiness, int health, int money, string name, ofstream & fout ) {
  ...
  for ( int i = 0; i < 2; i++ ) {
    ...
    if ( happiness == 2 && *prev != 1 ) {
      ...
      *prev = 6;
      cout << "Your friends invite you over to karaoke!" << endl;
      cout << "1. Go for it!" << endl;
      cout << "2. Nah I'm staying home..." << endl;

      cout << "Enter choice: ";
      cin >> choice;

      fout << "Your friends invite you over to karaoke!" << endl;
      if (choice == 1) {
        cout << "You had a great time! You guys made plans to meet up again soon." << endl;
        cout << "<+1 happiness>" << endl;
        updateStats(s, 0, 0, 1);

        fout << endl << "Choice: Go for it!" << endl;
        fout << "You had a great time! You guys made plans to meet up again soon." << endl;
      }
      else if (choice == 2) {
        cout << "They posted cool vides on Instagram and now you kinda regret not going..." << endl;
        cout << "<-1 happiness>" << endl;
        updateStats(s, 0, 0, -1);

        fout << endl << "Nah I'm staying home..." << endl;
        fout << "They posted cool vides on Instagram and now you kinda regret not going..." << endl;
      }
    }
